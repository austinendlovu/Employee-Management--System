...
import { EmployeeLeaveTracking } from "@/pages/employee/LeaveTracking";
        ...
        <AuthProvider>
          <Routes>
            ...
            <Route path="/employee" element={
              ...
              <Route path="leave-tracking" element={<EmployeeLeaveTracking />} />
            ...
            <Route path="/admin" element={
              ...
              <Route path="reports" element={<AdminWorkReports />} />
            </Route>
